...
**Ein Beleg entsteht über die Route, seine Zeilen über den Postausgang.** Das Anlegen geht an `POST /documents`, weil der Server dabei aus dem Kunden und den Angaben des Betriebs vorschlägt, wie der Beleg besteuert wird; über den Postausgang käme er mit der Vorgabe an, und ein Kleinunternehmer schriebe sein erstes Angebot mit Umsatzsteuer. Kopf, Texte und Zeilen gehen danach durch den Postausgang wie jeder andere Datensatz. Menge und Preis werden getippt, wie man sie hier schreibt, "2,5" und "1.234,56", und nie über `parseFloat` gelesen, das aus "1.234,56" ein 1,234 machte.
