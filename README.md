...
Was dieser Teil noch nicht kann: die Teilrechnung, eine Rechnung aus mehreren Regieberichten zugleich, den Mengenabgleich aus Abschnitt 1.4 (angeboten, geliefert, abgerechnet) und das Storno. Das Storno kommt als nächster Schritt von #74.
...
Was ausdrücklich noch fehlt und je ein eigenes Issue bekommt: das Storno, Prüfprotokoll, Zeiterfassung, der Aufbau unterhalb der Anlage (Verteiler, Feld, Stromkreis) und die Plantafel.
