...
- Neu: Die Hinweise, wann kein Widerrufsrecht besteht und unter welchen Umständen es vorzeitig erlischt (Art. 246a §1 Abs. 3 EGBGB), als vierte mitgelieferte Belehrung. Das Gesetz hat dafür kein Muster; ihr Wortlaut und der neue des Vordrucks kommen aus der Widerrufsbelehrung eines Handwerksbetriebs, an der Nummerierung von §356 BGB berichtigt, die sich am 19.06.2026 geändert hat, und stehen mit den Mustern zur fachkundigen Prüfung
